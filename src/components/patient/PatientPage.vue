        ...
        <v-toolbar flat>
          ...
          <v-dialog v-model="dialog" max-width="500px">
            <template v-slot:activator="{ on, attrs }">
              <v-btn color="primary" dark class="mb-2" v-bind="attrs" v-on="on">New Patient</v-btn>
            </template>
            <v-card>
              <v-card-title>
...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm() {
      this.$store.dispatch("deletePatient", this.editedItem.id);
      this.closeDelete();
    },
    ...
    save() {
      if (this.editedIndex > -1) {
        ...
        this.$store.dispatch("addPatient", this.editedItem);
      }
      this.close();
    }
  }
